...
<body>
    ...
    <?php
        ...
        $query = mysqli_query($konek, "SELECT * FROM controlling WHERE idTanaman = '$idTanaman'");
        $data = mysqli_fetch_array($query);
    ?>

    <section class="inputParamter">
        <h1 class="judul">EDIT PARAMETER TANAMAN</h1>
            ...
            <div class="container-fluid login">
                ...
                <div class="body-container-login">
                    ...
                    <form action="update.php" method="POST">
                        ...
                        <a href="index.php"><button type="button" class="btn btn-primary btn-sm" 
                            style="margin: 20px 10px; width: 150px; border-radius: 25px; font-weight: bold; text-align: center;
                            background: #A2B29F; color: #F8EDE3; padding-left: 3px; padding: 10px 0;">Kembali</button></a>
                    </form>
                </div>
            </div>
    </section>
